$(document).ready(function () {
    ...
    //var iii = 1;
    //window.initialSettings = function () {
    //    while ((localStorage["lastFM"] == "" || localStorage["lastFM"] == null || localStorage["lastFM"] == undefined) && window.location.hash) {
    ...
    //                    var accToken = $.parseJSON(accessData["access_token"]);
    //                    console.log(accToken);
    //                    var token = accessData;
    //                    localStorage["Snapster"] = accessData["playlist"];
    //                    localStorage["lastFM"] = $.parseJSON(accessData["lastFM"]);
    //                    localStorage["partyid"] = $.parseJSON(accessData["partyID"]);
    //                    localStorage["url"] = $.parseJSON(accessData["access_token"]);
    //                    localStorage["userID"] = accessData["username"];
